...
class DynamicMapDiscriminatorChildTestModel(
    DynamicMapDiscriminatorTestModel, discriminator="Child"
):
    value = UnicodeAttribute()
...
class TestDiscriminatorAttribute:
    def test_serialize(self):
        ...
        dtm.values = [
            NumberValue(name="bar", value=5),
            RenamedValue(name="baz", value="World"),
        ]
