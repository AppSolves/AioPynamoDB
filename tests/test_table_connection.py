...
class ConnectionTestCase(IsolatedAsyncioTestCase):
    ...
    def test_create_connection(self):
        ...
        conn = TableConnection(
            self.test_table_name, meta_table=MetaTable(DESCRIBE_TABLE_DATA[TABLE_KEY])
        )
    ...
    async def test_update_table(self):
        ...
        with patch(PATCH_METHOD) as req:
            ...
            await conn.update_table(read_capacity_units=2, write_capacity_units=2)
    ...
    async def test_delete_item(self):
        ...
        with patch(PATCH_METHOD) as req:
            req.return_value = {}
            await conn.delete_item("Amazon DynamoDB", "How do I update multiple items?")
            params = {
    ...
    async def test_update_item(self):
        ...
        with patch(PATCH_METHOD) as req:
            ...
            params = {
                ...
                "ExpressionAttributeNames": {"#0": "Subject"},
    ...
    async def test_get_item(self):
        ...
        with patch(PATCH_METHOD) as req:
            ...
            item = await conn.get_item(
                "Amazon DynamoDB", "How do I update multiple items?"
            )
    ...
    async def test_query(self):
        ...
        with patch(PATCH_METHOD) as req:
            req.return_value = {}
            await conn.query("FooForum", Path("Subject").startswith("thread"))
            params = {
                "ReturnConsumedCapacity": "TOTAL",
