...
class ProjectionExpressionTestCase(TestCase):
    ...
    def test_create_projection_expression(self):
        ...
        projection_expression = create_projection_expression(
            attributes_to_get, self.placeholders
        )
...
class ConditionExpressionTestCase(TestCase):
    ...
    def test_equal(self):
        ...
        expression = condition.serialize(
            self.placeholder_names, self.expression_attribute_values
        )
